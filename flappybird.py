...
def en():
  ...
  if turtle.pos()==(460,130) and wn.bgpic()=="mm.gif" :
    ...
    # Main Game Loop
    while True:
        if wn.bgpic()=="quitrun.gif" or wn.bgpic()=="gamepause.gif":
         player.sety(qstop)
        ...
        # Add gravity
        if wn.bgpic()!="quitrun.gif" and wn.bgpic()!="gamepause.gif":
          player.dy += gravity
